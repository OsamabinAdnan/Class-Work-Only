...
if (marks >= 90 && marks <= 100) {
    console.log("\"You got A+ grade in ".concat(subject, "\""));
    ...
    console.log("\"You got B grade in ".concat(subject, "\""));
    console.log("Good!");
}
else if (marks >= 60 && marks <= 69) {
    console.log("\"You got C grade in ".concat(subject, "\""));
    console.log("Fair!");
}
else if (marks >= 50 && marks <= 59) {
    console.log("\"You got D grade in ".concat(subject, "\""));
    console.log("Need Improvement!");
}
else {
    console.log("\"You are fail in ".concat(subject, "\""));
