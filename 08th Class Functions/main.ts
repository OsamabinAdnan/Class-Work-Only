...
halfFryEgg();
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> RETURNING FUNCTION <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<//
function halfFryEggs():number{
    let cooked = 3 + 1.5 + 5;
    return cooked
}
let response:number = halfFryEggs() //invoking the function
...
function user_info (name:string, age:number, email:any){
...
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>SQUARE ROOT<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<//
function square_root(digit:number) {
    console.log(digit*digit)
}
square_root(16);
square_root(125);
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>CUBE ROOT<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<//
function cube_root(digit:number) {
    console.log(digit*digit*digit)
}
cube_root(16);
cube_root(125);
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>ADDITION<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<//
function addition(digit1:number, digit2:number){
