//=============================================== Structural Typing ===============================================//
/*
Normally 2 types of typing
1) Structural 2) Nominal
In structural typing we will see object's structure form
It could be type alias or interface as well
...
interface Sphere {
  ...
  //If problem is in property or data type then error will come
  // We can used type alias or inline typing here instead of interface
